...
class VMambaTrainer(BaseTrainer):
    def __init__(self, params):
        super(VMambaTrainer, self).__init__(params)
    def real_init(self):
        # net
        model_config = get_config(self.params['net']['model_config'])
        self.net = build_model(model_config).to(self.device)
        # loss
...
def get_trainer(params):
    ...
    elif trainer_type == "vmamba":
        return VMambaTrainer(params)
